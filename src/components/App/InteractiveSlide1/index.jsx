  ...
  render() {
    ...
    return (
      <div id={styles.root}>
        ...
        <div id={styles.rootMap}>
          <svg
            viewBox="0 0 950 620"
            id={styles.rootMapSvg}
          >
            <path
              id="kalimantan"
            ...
            <path
              ...
              className={styles.rootMapSvgCountry}
              style={{ fill: 'rgb(247,252,240)' }}
              onClick={() => setCountrySlide1('mexico')}
            />
            <path
              id="estonia"
            ...
            <path
              ...
              onClick={() => setCountrySlide1('russia')}
            />
            <path
              id="china"
...
InteractiveSlide1.propTypes = {
  countrySlide1: PropTypes.string,
  setCountrySlide1: PropTypes.func.isRequired,
};
InteractiveSlide1.defaultProps = {
  countrySlide1: null,
};
export default connect(
  state => ({
    countrySlide1: fromCountrySlide1.getCountrySlide1(state),
  }),
  {
    setCountrySlide1: fromCountrySlide1.setCountrySlide1,
  },
)(InteractiveSlide1);
