...
function App({
  ...
  let interactiveId = styles.rootInteractive;
  let prevId = styles.rootControlsPrev;
  let nextId = styles.rootControlsNext;
  let prevAdjacentClass = styles.rootControlsPrevAdjacent;
  if (wall !== null) {
    interactiveId = styles.rootInteractiveWall;
    prevId = styles.rootControlsPrevWall;
    nextId = styles.rootControlsNextWall;
    prevAdjacentClass = styles.rootControlsPrevWallAdjacent;
  }
  return (
    <div id={styles.root}>
      <svg
      ...
      >
        <path
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(78,179,211)' : '#000000' }}
        />
        <path
          id="papua new guinea"
        ...
        <path
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(247,252,240)' : '#000000' }}
        />
        <path
          id="estonia"
        ...
        <path
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(8,104,172)' : '#000000' }}
        />
        <path
          id="usa"
        ...
        <path
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(224,243,219)' : '#000000' }}
        />
        <path
          id="peru"
        ...
        <path
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(123,204,196)' : '#000000' }}
        />
        <path
          id="chiloe"
        ...
        <path
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(255,255,255)' : '#000000' }}
        />
        <path
          id="china"
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(8,64,129)' : '#000000' }}
        />
        <path
          id="mongolia"
        ...
        <path
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(204,235,197)' : '#000000' }}
        />
        <path
          id="nepal"
        ...
        <path
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(43,140,190)' : '#000000' }}
        />
        <path
          id="malaysia"
        ...
        <path
          ...
          className={styles.rootSvgCountry}
          style={{ fill: slide === 1 ? 'rgb(168,221,181)' : '#000000' }}
        />
        <path
          id="georgia"
        ...
        {slide === 1 &&
          <g>
            <path
              id="SEA-USA-RUS"
              d="M 723.09858,124.51388 C 575.59647,9.0476471 148.06873,-46.087953 207.62799,207.04329"
              style={{
                stroke: 'rgba(255,255,255,0.5)',
                strokeWidth: '7',
              }}
              className={styles.rootSvgLine}
            />
            <path
              id="SEA-USA-MEX"
              d="m 170.82,262.54 c -9.81,-23.91 -3.29665,-48.90158 36.80799,-55.49671"
              style={{
                stroke: 'rgba(247,252,240,0.5)',
                strokeWidth: '10',
              }}
              className={styles.rootSvgLine}
            />
            <path
              id="SEA-USA-ECU"
              d="m 232.12799,344.54329 c -77.31898,-32.54191 -57.44,-90.49 -24.5,-137.5"
              style={{
                stroke: 'rgba(224,243,219,0.5)',
                strokeWidth: '19',
              }}
              className={styles.rootSvgLine}
            />
            <path
              id="SEA-USA-IND"
              d="M 675.55091,268.91303 C 592.22039,210.17318 348.87,136.26 207.62799,207.04329"
              style={{
                stroke: 'rgba(204,235,197,0.5)',
                strokeWidth: '23',
              }}
              className={styles.rootSvgLine}
            />
            <path
              id="SEA-USA-VNM"
              d="M 747.49,284.93 C 596.43,383.65 305.89842,269.97662 207.62799,207.04329"
              style={{
                stroke: 'rgba(168,221,181,0.5)',
                strokeWidth: '30',
              }}
              className={styles.rootSvgLine}
            />
            <path
              id="SEA-USA-CHL"
              d="M 261.5,472.27 C 101.32875,391.27725 47.132205,236.98237 207.62799,207.04329"
              style={{
                stroke: 'rgba(123,204,196,0.5)',
                strokeWidth: '30',
              }}
              className={styles.rootSvgLine}
            />
            <path
              id="SEA-USA-IDN"
              d="M 746.36,330.1 C 544.04075,498.82495 223.22,354.61 207.62799,207.04329"
              style={{
                stroke: 'rgba(78,179,211,0.5)',
                strokeWidth: '30',
              }}
              className={styles.rootSvgLine}
            />
            <path
              id="SEA-USA-THA"
              d="M 728.2,283.42 C 546.95384,139.44047 262.84,160.35 207.62799,207.04329"
              style={{
                stroke: 'rgba(43,140,190,0.5)',
                strokeWidth: '35',
              }}
              className={styles.rootSvgLine}
            />
            <path
              id="SEA-USA-CAN"
              d="m 207.62799,207.04329 c -5.18479,-15.63873 -24.82157,-57.31717 -18.27957,-82.7957"
              style={{
                stroke: 'rgba(8,104,172,0.5)',
                strokeWidth: '56',
              }}
              className={styles.rootSvgLine}
            />
            <path
              id="SEA-USA-CHN"
              d="M 722.96541,220.54022 C 571.57,59.79 282.22,45.72 207.62799,207.04329"
              style={{
                stroke: 'rgba(8,64,129,0.5)',
                strokeWidth: '57',
              }}
              className={styles.rootSvgLine}
            />
      ...
      >
        {slide !== 0 &&
          <div
            id={prevId}
            className={slide === LAST_SLIDE ? null : prevAdjacentClass}
